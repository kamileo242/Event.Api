...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        {
            new Event(Guid.NewGuid(), "Event 1", "Event 1 opis", DateTime.UtcNow.AddHours(2), DateTime.UtcNow.AddHours(4)),
            new Event(Guid.NewGuid(), "Event 2", "Event 2 opis", DateTime.UtcNow.AddHours(1), DateTime.UtcNow.AddHours(10))
        };
